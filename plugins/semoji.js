...
let handler = async(m, { conn, usedPrefix, command, args, text, }) => {
    ...
    let ras = `හෙලෝ  @${m.sender.split('@')[0]}`
    let sel = `ඉමොජි වර්ග කිහිපයක් තිබේ, ඔබට අවශ්‍ය කුමන ආකාරයේ ඉමොජිද?  පහතින් තෝරන්න ඔව් සහෝදරිය!\nඔබට ඉමොජි 1ක් පමණක් තබා ඉමොජි භාවිතා කළ හැකි බව කරුණාවෙන් සලකන්න!`
    let rs = `පහතින් තෝරන්ම`
const sections = [ {
	title: `ඉමෝජි වර්ගය කුමක්ද`,
	rows: [
